...
export class SettingsService {
  ...
  constructor() {
    this.settings =
      (JSON.parse(
        localStorage.getItem(settingsStoreKey) as string
      ) as ISettings) ?? defaultSettings;
  }
  ...
  get readTranslatesCount() {
    return this.settings.readTranslatesCount;
  }
  ...
  get goWordsCount() {
    return this.settings.goWordsCount;
  }
